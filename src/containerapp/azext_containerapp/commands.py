...
def load_command_table(self, _):
    with self.command_group('containerapp') as g:
        ...
        g.custom_command('exec', 'containerapp_ssh', validator=validate_ssh)  # does not work with connected
    ...
    with self.command_group('containerapp logs') as g:
        g.custom_show_command('show', 'stream_containerapp_logs', validator=validate_ssh)  # does not work with connected
